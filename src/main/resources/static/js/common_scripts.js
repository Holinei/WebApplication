...
(function (a) {
    var e = function (d, c) {
        this.options = c;
        var b = a(d), g = b.is("img"), f = g ? b.attr("src") : b.backgroundImageUrl(),
...
!function (e, s) {
    ...
    e.extend(t.prototype, {
        _isOpenSelectbox: function (e) {
            ...
            function n() {
                var t = !(!arguments[1] || !arguments[1].sub), a = !(!arguments[1] || !arguments[1].disabled);
                arguments[0].each(function (n) {
                    var l, r = e(this), g = e("<li>");
                    r.is(":selected") && (o.text(r.text()), p = i), n === f - 1 && g.addClass("last"), r.is(":disabled") || a ? (l = e("<span>", {text: r.text()}).addClass(b.settings.classDisabled), t && l.addClass(b.settings.classSub), l.appendTo(g)) : (l = e("<a>", {
                        href: "#" + r.val(),
                        rel: r.val()
            ...
            var l, o, c, d, r = e(s), u = this, b = u._newInst(r), p = !1, g = (r.find("optgroup"), r.find("option")),
                f = g.length;
            r.attr("sb", b.uid), e.extend(b.settings, u._defaults, t), u._state[b.uid] = !1, r.hide(), l = e("<div>", {
                ...
                id: "sbToggle_" + b.uid, href: "#", class: b.settings.classToggle, click: function (t) {
                    t.preventDefault(), a.apply(e(this), []);
                    var i = e(this).attr("id").split("_")[1];
                    u._state[i] ? u._closeSelectbox(s) : u._openSelectbox(s)
                }
                ...
                var t = s.charCode ? s.charCode : s.keyCode ? s.keyCode : 0, i = e(this), a = i.data("uid"),
            ...
            if (t && !t.isOpen && !t.isDisabled) {
                var a = e("#sbOptions_" + t.uid), n = parseInt(e(window).height(), 10),
                    l = e("#sbHolder_" + t.uid).offset(), o = e(window).scrollTop(), c = a.prev().height(),
                    d = n - (l.top - o) - c / 2, r = this._get(t, "onOpen");
                a.css({
                    top: c + "px",
                    maxHeight: d - c + "px"
            ...
            if (!r.data("sticky_kit")) {
                ...
                if (f = g = !1, (w = null != V ? V && r.closest(V) : S("<div />")) && w.css("position", r.css("position")), (v = function () {
                    ...
                    if (!u) return o = !1, null != b && (b -= 1) <= 0 && (b = I, v(), o = !0), o || _ === k || (v(), o = !0), e = W.scrollTop(), null != h && (i = e - h), h = e, g ? (x && (s = a + l < e + p + y, f && !s && (f = !1, r.css({
                        ...
                        width: "",
                        top: ""
                    }, r.css(t).removeClass(A).trigger("sticky_kit:unstick")), P && M < p + F && (f || (y -= i, y = Math.max(M - p, y), y = Math.min(F, y), g && r.css({top: y + "px"})))) : c < e && (g = !0, (t = {
                        position: "fixed",
                        top: y
                    }).width = "border-box" === r.css("box-sizing") ? r.outerWidth() + "px" : r.width() + "px", r.css(t).addClass(A), null == V && (r.after(w), "left" !== d && "right" !== d || w.append(r)), r.trigger("sticky_kit:stick")), g && x && (null == s && (s = a + l < e + p + y), !f && s) ? (f = !0, "static" === m.css("position") && m.css({position: "relative"}), r.css({
                        position: "absolute",
                        bottom: n,
                        top: "auto"
